...
- **nRF5340-DK**: Anturidatan, kuten kiihtyvyyden ja asennon mittaus (GY-61 ADXL335), sekä langaton tiedonsiirto Rasberrylle 433Mhz Bluetooth yhteyttä käyttäen.
...
- **Kannettava tietokone**: Haetaan tietoa MySQL tietokannasta HTTP-protokollalla jne jne...

### Käyttöjärjestelmät ja työkalut
- **Windows**: Windows 11 ja 10.
- **Linux**: debian pohjainen uusin versio 32bit Raspberry Pi OS.
- **Github ja GitBash**
...
- **MySQL**: Koulun valmiiksi luoma tietokanta Linux-serverillä.
...
### Viestintä
- **Discord**: Opettajan luoma Discord-kanava sekä erilliset yhteistyö -kanavat.
- **Sähköposti**:
